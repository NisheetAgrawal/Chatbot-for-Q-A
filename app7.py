...
BHASHINI_HEADERS = {
    ...
    "ulcaApiKey": "2d6f1cf41fbb4befa9e7209a0b64e5da",  # Replace with your ULCA API key
    "userID": "5047f9b849-2ad2-499a-9a5f-e2556b2aab2d",  # Replace with your User ID
    "Authorization": "-Cco1oZ9q2bWA5QbT3t-ngbWMhmiI4joE33fnyz4Aba__XtuEa0EiSU7wJmVbzN9"  # Replace with your Auth Header
}
...
def retrieve_document(query, user_lang):
    ...
    try:
        ...
        # If query is not in English, translate it to English
        ...
        if detected_lang != "en":
            ...
            if not query:
                return "Failed to translate query to English."
        ...
        if max(cosine_scores) < 0.5:  # Confidence threshold
        ...
        if detected_lang != "en":
            ...
            translated_response = translate_text(response, "en", detected_lang)
            print(f"Translated response: {translated_response}")
            if not translated_response:
                return "Failed to translate response to your language."
